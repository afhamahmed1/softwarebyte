    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                if (isset($_GET['id'])) {
                    $id = $_GET["id"];
                    $tags_table = "project_tags";
                    $section = $_GET["section"];

                    $item = getById("projects", $id);
                    ...
                    <div class="card-body" style="overflow-y:auto">
                        ...
                        <form action="code.php" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <label class='mb-1' for="">Project Number</label>
                                    <input type="text" required value="<?= $item["number"] ?>" name='number' placeholder="Enter Project Number" class="form-control mb-2">
                                </div>
                                <div class="col-md-3">
                ...
                <?php
                    ...
                    redirect("view_projects.php", "please choose the item to be edited");
                }
