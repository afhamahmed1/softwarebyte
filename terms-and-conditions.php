...
<section class="container" style="display:flex; align-items: center;">
    <div style="margin-top:20px;">
        ...
        <p>Welcome to<b>Software Byte</b>("Company",
            "we", "our", "us")!</p>

        <p>These
            Terms of Service ("Terms", "Terms of Service") govern your use of our website
            located at&nbsp;<span class=url><b>softwarebyte.co</b></span>&nbsp;(together or
            individually "Service") operated by&nbsp;<span class=company-name><b>Software
                    Byte</b></span>.</p>
        ...
        <p>If you
            ...
            Service, but please let us know by emailing at&nbsp;<span class=email><b>hrsoftwarebyte@gmail.com</b></span>&nbsp;so
        ...
        <p>By
            ...
            unsubscribe link or by emailing at&nbsp;<span class=email>hrsoftwarebyte@gmail.com</span>.</p>
        ...
        <p>You represent and warrant that: (<span class=SpellE>i</span>)
        ...
        <p>We may employ the use of third party services for the purpose of
        ...
        <p>We reserve the right to refuse or cancel your order at any time for
        ...
        <p>We
            issue refunds for Contracts within&nbsp;<span class=refund-days><b>7</b></span><b>&nbsp;days</b>&nbsp;of
            the original purchase of the Contract.</p>

        <h2>6.&nbsp;Content</h2>

        <p>Content
            found on or through this Service are the property of&nbsp;<span class=company-name>Software Byte</span>&nbsp;or used with permission. You may
        ...
        <p>0.6. To engage in any other conduct that restricts or inhibits
            ...
            or offend Company or users of Service or expose them to liability.</p>
        ...
        <p>0.1. Use Service in any manner that could disable, overburden,
            ...
            including their ability to engage in real time activities through Service.</p>
        ...
        <p>0.5. Introduce any viruses, <span class=SpellE><span class=GramE>trojan</span></span> horses, worms, logic bombs, or other material
            which is malicious or technologically harmful.</p>

        <p>0.6. Attempt to gain unauthorized access to, interfere with, damage,
            or disrupt any parts of Service, the server on which Service is stored, or any
            server, computer, or database connected to Service.</p>
        ...
        <h2>9.&nbsp;No
            Use <span class=GramE>By</span> Minors</h2>
        ...
        <p>Service is intended only for access and use by individuals at
            ...
            old, you are prohibited from both the access and usage of Service.</p>
        ...
        <p>Service
            ...
            functionality are and will remain the exclusive property of&nbsp;<span class=company-name>Software Byte</span>&nbsp;and its licensors. Service is
            ...
            service without the prior written consent of&nbsp;<span class=company-name>Software
                Byte</span>.</p>
        ...
        <p>If you
            ...
            infringement, please submit your claim via email to&nbsp;<span class=email>hrsoftwarebyte@gmail.com</span>,
            ...
            Notice and Procedure for Copyright Infringement Claims"</p>
        ...
        <h2>12.&nbsp;DMCA
            Notice and Procedure for Copyright Infringement Claims</h2>
        ...
        <p>You may submit a notification pursuant to the Digital Millennium
            ...
            information in writing (see 17 U.S.C 512(c<span class=GramE>)(</span>3) for
            further detail):</p>

        <p>0.1. <span class=GramE>an</span> electronic or physical
        ...
        <p>0.2. a description of the copyrighted work that you claim has
            ...
            the copyrighted work exists or a copy of the copyrighted work;</p>

        <p>0.3. <span class=GramE>identification</span> of the URL or other
            specific location on Service where the material that you claim is infringing is
            located;</p>

        <p>0.4. <span class=GramE>your</span> address, telephone number,
            and email address;</p>

        <p>0.5. <span class=GramE>a</span> statement by you that you have a
            good faith belief that the disputed use is not authorized by the copyright
            owner, its agent, or the law;</p>

        <p>0.6. <span class=GramE>a</span> statement by you, made under
        ...
        <p>You can
            contact our Copyright Agent via email at&nbsp;<span class=email>hrsoftwarebyte@gmail.com</span>.</p>

        <h2>13.&nbsp;Error
            Reporting and Feedback</h2>

        <p>You may
            provide us either directly at&nbsp;<span class=email>hrsoftwarebyte@gmail.com</span>&nbsp;or
            ...
            matters related to our Service ("Feedback"). You acknowledge and agree that: (<span class=SpellE>i</span>) you shall not retain, acquire or assert any intellectual
            property right or other right, title or interest in or to the Feedback; (ii)
            Company may have development ideas similar to the Feedback; (iii) Feedback does
            ...
            with respect to the Feedback. In the event the transfer of the ownership to the
        ...
        <h2>14.&nbsp;Links
            <span class=GramE>To</span> Other Web Sites
        </h2>

        <p>Our
            Service may contain links to third party web sites or services that are not
            owned or controlled by&nbsp;<span class=company-name>Software Byte</span>.</p>

        <p>Software Byte&nbsp;has no control over, and
        ...
        <h2>15.&nbsp;Disclaimer
            <span class=GramE>Of</span> Warranty
        </h2>
        ...
        <p>THESE SERVICES ARE PROVIDED BY COMPANY ON AN "AS IS" AND "AS
            ...
            CONTENT OR MATERIALS INCLUDED THEREIN. YOU EXPRESSLY AGREE THAT <span class=GramE>YOUR</span> USE OF THESE SERVICES, THEIR CONTENT, AND ANY SERVICES
            OR ITEMS OBTAINED FROM US IS AT YOUR SOLE RISK.</p>
        ...
        <h2>16.&nbsp;Limitation
            <span class=GramE>Of</span> Liability
        </h2>
        ...
        <p>EXCEPT AS PROHIBITED BY LAW, YOU WILL HOLD US AND OUR OFFICERS,
            ...
            THE PRIOR LIMITATION OR EXCLUSION MAY NOT APPLY TO YOU.</p>
        ...
        <p>These
            Terms shall be governed and construed in accordance with the laws of&nbsp;<span class=country-name>United States</span>, which governing law applies to
        ...
        <p>Our failure to enforce any right or provision of these Terms
            ...
            prior agreements we might have had between us regarding Service.</p>

        <h2>19.&nbsp;Changes
            <span class=GramE>To</span> Service
        </h2>
        ...
        <h2>20.&nbsp;Amendments
            <span class=GramE>To</span> Terms
        </h2>

        <p>We may amend Terms at any time by posting the amended terms on
            this site. It is your responsibility to review these Terms periodically.</p>
        ...
        <h2>21.&nbsp;Waiver
            <span class=GramE>And</span> Severability
        </h2>
        ...
        <p>BY USING SERVICE OR OTHER SERVICES PROVIDED BY US, YOU ACKNOWLEDGE
            THAT YOU HAVE READ THESE TERMS OF SERVICE AND AGREE TO BE BOUND BY THEM.</p>

        <h2>23.&nbsp;Contact
            Us</h2>

        <p>Please
            send your feedback, comments, <span class=GramE>requests</span> for technical
            support by email:&nbsp;<span class=email><b>hrsoftwarebyte@gmail.com</b></span>.</p>
