...
<section class="container" style="display:flex; align-items: center;">
    <div style="margin-top:20px;">
        ...
        <p><b>Company</b>
            ...
            or &quot;Our&quot; in this Agreement) refers to Software Byte, Dallas.</p>
        ...
        <p><b>Country</b>
            refers to: Texas, United States</p>
        ...
        <p><b>Website</b>
            refers to <span class=SpellE>SoftwareByte</span>, accessible from <a href="index.php"><span style='color:windowtext;
                text-decoration:none; text-underline:none'>www.softwarebyte.co</span></a></p>
        ...
        <p>Address, State, Province, ZIP/Postal code,
            City</p>
        ...
        <p><b>Cookies
                or Browser Cookies.</b> A cookie is a small file placed on Your Device. You can
            ...
            that it will refuse Cookies, our Service may use Cookies.</p>

        <p><b>Flash
                Cookies.</b> Certain features of our Service may use local stored objects (or
            ...
            disabling, or deleting local shared objects?&quot; available at <a href="https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.php#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_"><span style='color:windowtext;text-decoration:none;text-underline:none'>https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.php#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_</span></a></p>
        ...
        <p>Cookies can be &quot;Persistent&quot; or &quot;Session&quot;
            ...
            Your web browser. You can learn more about cookies on <a href="https://www.termsfeed.com/blog/cookies/#What_Are_Cookies"><span style='color:windowtext;text-decoration:none;text-underline:none'>TermsFeed
                    website</span></a> article.</p>
        ...
        <p><b>To
                provide and maintain our Service</b>, including to monitor the usage of our Service.</p>
        ...
        <p>The Company will retain Your Personal Data only for as long as
        ...
        <p>Protect and defend the rights or property of the
            Company</p>

        <p>Prevent or investigate possible wrongdoing in
            connection with the Service</p>

        <p>Protect the personal safety of Users of the
        ...
        <p>By email: hrsoftwarebyte@gmail.com</p>

        <p>By visiting this page on our website: <a href="contact-us"><span style='color:windowtext;
                text-decoration:none;text-underline:none'>softwarebyte.co/contact-us</span></a></p>
